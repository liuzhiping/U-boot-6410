...
issac_6410_noUSB_config	\
issac_6410_config	:	unconfig
	@mkdir -p $(obj)include $(obj)board/samsung/issac_6410
	@mkdir -p $(obj)nand_spl/board/samsung/issac_6410
	@echo "#define CONFIG_NAND_U_BOOT" > $(obj)include/config.h
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
	@if [ -z "$(findstring issac_6400_noUSB_config,$@)" ]; then			\
		echo "RAM_TEXT = 0x57e00000" >> $(obj)board/samsung/issac_6410/config.tmp;\
	else										\
		echo "RAM_TEXT = 0xc7e00000" >> $(obj)board/samsung/issac_6410/config.tmp;\
	fi
	@$(MKCONFIG) smdk6400 arm arm1176 issac_6410 samsung s3c64xx
	@echo "CONFIG_NAND_U_BOOT = y" >> $(obj)include/config.mk
#========================================================================
# Nios
#========================================================================
